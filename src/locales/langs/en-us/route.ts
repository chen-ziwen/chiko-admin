const route = {
  ...
  '(base)_multi-menu_first_child': 'First Level Menu',
  '(base)_multi-menu_first_child_home': 'Second Level Home',
  '(base)_multi-menu_second': 'Menu Two',
  '(base)_multi-menu_second_child': 'First Level Menu',
  '(base)_multi-menu_second_child_home': 'First Level Home',
